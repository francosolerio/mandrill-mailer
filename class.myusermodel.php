...
class MyUserModel extends Gdn_Model {
...
//      }
   ...
   public function SendEmailConfirmationEmail($User = NULL) {
      ...
      LogMessage(basename(__FILE__),__LINE__,__CLASS__,__METHOD__,"HAI CHIAMATO IL MYUSERMODEL!");
      ...
      $Email->Send("METTOUNCAZZODINOMEEVENTO"); //Metto un argomento così Email::Send lancia FireEvent e il plugin lo raccoglie
